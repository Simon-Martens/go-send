...
fileTooBig = Dat bestand is te groot om te worden ge\xFCpload. Het moet kleiner zijn dan { $size }.
...
-firefox = Firefox
-mozilla = Mozilla
introTitle = Bestanden delen, eenvoudig en priv\xE9
introDescription = Met { -send-brand } kunt u bestanden delen met end-to-endversleuteling en een koppeling die automatisch verloopt. Hierdoor kunt u priv\xE9 houden wat u wilt delen en er zeker van zijn dat uw zaken niet voor altijd online blijven.
...
copyLinkButton = Koppeling kopi\xEBren
...
tooManyFiles =
    { $count ->
        [one] Er kan slechts \xE9\xE9n bestand tegelijk worden ge\xFCpload.
       *[other] Er kunnen slechts { $count } bestanden tegelijk worden ge\xFCpload.
    }
# count will always be > 10
tooManyArchives =
    { $count ->
        [one] Slechts \xE9\xE9n archief is toegestaan.
...
accountBenefitTimeLimit =
    { $count ->
        [one] Koppelingen tot \xE9\xE9n dag actief houden
...
noStreamsOptionCopy = Koppeling kopi\xEBren om in een andere browser te openen
...
//# sourceMappingURL=nl-H2SXW64B.js.map
