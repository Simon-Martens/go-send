...
uploadGuestBannerMessageGuest = Denken Sie daran, sich auf unvertrauenswürdigen Geräten abzumelden!
uploadGuestBannerMessageEphemeral = Dieser Computer ist nicht vertrauenswürdig! Bitte melden Sie sich ab!
...
settingsUsersIntro = Stellen Sie Einladungslinks für neue Administratoren oder Standardbenutzer aus. Die Links laufen nach 7 Tagen ab und können nur einmal verwendet werden.
settingsUsersAdminTitle = Administrator-Anmeldelinks
settingsUsersAdminDescription = Erstellen Sie einmalige Einladungen für Administrator-Konten.
settingsUsersUserTitle = Benutzer-Anmeldelinks
settingsUsersUserDescription = Erstellen Sie einmalige Einladungen für Standardbenutzer.
...
settingsUsersDetailDescription = Teilen Sie diesen Link. Er läuft am { $date } ab und kann nur einmal verwendet werden.
...
settingsUsersKeySigning = Signaturschlüssel
settingsUsersKeyEncryption = Verschlüsselungsschlüssel
...
settingsUploadLinksDescription = Gästelinks zum Hochladen erstellen und verwalten. Diese Links ermöglichen Uploads ohne Anmeldung.
settingsUploadLinksLabelLabel = Linkbezeichnung
settingsUploadLinksLabelHint = Verwenden Sie einen aussagekräftigen Namen, damit Sie den Link später wiedererkennen.
...
settingsUploadLinksGeneralHint = Erlaubt Uploads für jeden Benutzer (allgemeiner Eingang)
