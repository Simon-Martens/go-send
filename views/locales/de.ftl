...
downloadSecurityNotice = Alle Downloads, zugehörige Benutzerdaten und Benutzerinteraktionen auf dieser Seite werden protokolliert. Die Logs werden regelmäßig gelöscht.
...
passwordAlreadySet = Passwort ist bereits gesetzt und kann nicht geändert werden.
