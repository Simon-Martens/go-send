...
archiveExpiryInfo = Yn dod i ben ar \xF4l { $downloadCount } neu { $timespan }
timespanMinutes =
    { $num ->
        [zero] 0 munud
        [one] 1 munud
...
copyLinkDescription = Cop\xEFwch y ddolen i rannu eich ffeil:
copyLinkButton = Cop\xEFo'r ddolen
...
tooManyArchives =
    { $count ->
        [zero] Dim caniat\xE2d i archifau.
        [one] Dim ond 1 archif y'n cael ei ganiat\xE1u.
        [two] Dim ond { $count } archif sy'n cael eu caniat\xE1u.
        [few] Dim ond { $count } archif sy'n cael eu caniat\xE1u.
        [many] Dim ond { $count } archif sy'n cael eu caniat\xE1u.
       *[other] Dim ond { $count } archif sy'n cael eu caniat\xE1u.
    }
...
noStreamsOptionCopy = Cop\xEFwch y ddolen i'w agor mewn porwr arall
...
trailheadPromo = Mae ffordd o ddiogelu eich preifatrwydd. Ymunwch \xE2 Firefox.
learnMore = Dysgu rhagor.
`;
export {
  cy_default as default
};
//# sourceMappingURL=cy-VX5XDONN.js.map
