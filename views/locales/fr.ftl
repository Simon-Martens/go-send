...
settingsUsersGenerateAdmin = Créer un lien admin
settingsUsersGenerateUser = Créer un lien utilisateur
settingsUsersRevokeAdmin = Révoquer les liens admin
settingsUsersRevokeUser = Révoquer les liens utilisateur
...
settingsUploadLinksGeneralHint = (N'importe qui peut utiliser ce lien, pas seulement un utilisateur spécifique)
