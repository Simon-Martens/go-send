...
var RegisterLayoutElement = class extends HTMLElement {
  ...
  async showSuccess(name) {
    ...
    container.innerHTML = "";
    const content = template.content.cloneNode(true);
    const { translate: translate2, translateElement: translateElement2 } = await import("./utils-KI46TYU2.js");
  ...
  async setPlaceholders() {
    try {
      const { translate: translate2 } = await import("./utils-KI46TYU2.js");
...
//# sourceMappingURL=register-layout-VPIFKXK4.js.map
