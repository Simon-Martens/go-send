...
uploadGuestBannerMessageGuest = Pensez \xE0 vous d\xE9connecter sur les appareils non fiables !
uploadGuestBannerMessageEphemeral = Cet appareil n\u2019est pas de confiance ! Pensez \xE0 vous d\xE9connecter !
...
settingsAccountSubheading = G\xE9rez vos informations de profil, votre mot de passe et vos sessions de connexion.
settingsAccountProfileHeading = Profil
settingsAccountProfileDescription = Mettez \xE0 jour le nom et l\u2019adresse e-mail associ\xE9s \xE0 votre compte.
...
settingsAccountPasswordDescription = D\xE9finissez un nouveau mot de passe pour votre compte. Les changements prennent effet imm\xE9diatement.
...
settingsAccountPasswordSave = Mettre \xE0 jour le mot de passe
settingsAccountPasswordHint = Les mots de passe doivent comporter au moins 10 caract\xE8res.
settingsAccountDangerHeading = Sessions & acc\xE8s
settingsAccountDangerDescription = Effacez votre session actuelle ou d\xE9sactivez le compte. Les deux actions vous d\xE9connectent.
settingsAccountClearSessions = Effacer la session
settingsAccountDeactivate = D\xE9sactiver le compte
...
settingsAccountProfileStatusSuccess = Profil mis \xE0 jour.
settingsAccountProfileStatusError = Impossible de mettre \xE0 jour le profil. R\xE9essayez.
...
settingsAccountProfileStatusEmailInUse = Cette adresse e-mail est d\xE9j\xE0 utilis\xE9e.
settingsAccountDangerStatusNotActive = Votre compte est d\xE9j\xE0 d\xE9sactiv\xE9.
settingsAccountDangerStatusClearing = Effacement de votre session\u2026
settingsAccountDangerStatusDeactivating = D\xE9sactivation de votre compte\u2026
settingsAccountDangerStatusError = Impossible de terminer la requ\xEAte. R\xE9essayez.
settingsUploadLinksHeading = Liens d\u2019envoi
settingsUploadLinksDescription = Cr\xE9ez et g\xE9rez des liens d\u2019envoi invit\xE9s. Ces liens permettent de t\xE9l\xE9verser des fichiers sans se connecter.
...
settingsUploadLinksDescriptionPlaceholder = D\xE9tails facultatifs
settingsUploadLinksCreateButton = Cr\xE9er un lien d\u2019envoi
settingsUploadLinksStatusLabelRequired = Veuillez indiquer un nom avant de cr\xE9er le lien.
settingsUploadLinksStatusCreating = Cr\xE9ation du lien d\u2019envoi\u2026
settingsUploadLinksStatusCreated = Lien d\u2019envoi pr\xEAt.
settingsUploadLinksStatusError = Impossible de cr\xE9er le lien d\u2019envoi. R\xE9essayez.
settingsUploadLinksStatusRevoking = R\xE9vocation du lien d\u2019envoi\u2026
settingsUploadLinksStatusRevoked = Lien d\u2019envoi r\xE9voqu\xE9.
settingsUploadLinksStatusRevokeError = Impossible de r\xE9voquer le lien d\u2019envoi. R\xE9essayez.
settingsUploadLinksStatusLoading = Chargement des liens d\u2019envoi\u2026
settingsUploadLinksStatusLoadingError = Impossible de charger les liens d\u2019envoi. R\xE9essayez.
settingsUploadLinksDetailHeading = Nouveau lien d\u2019envoi cr\xE9\xE9
settingsUploadLinksDetailDescription = Copiez ce lien maintenant \u2014 il ne sera pas affich\xE9 \xE0 nouveau.
settingsUploadLinksDetailLabelName = Nom
settingsUploadLinksDetailHint = Partagez ce lien en toute s\xE9curit\xE9 avec votre invit\xE9.
settingsUploadLinksCopyButton = Copier le lien
settingsUploadLinksCopySuccess = Lien d\u2019envoi copi\xE9 dans le presse-papiers.
settingsUploadLinksCopyError = \xC9chec de la copie. Copiez manuellement le lien.
settingsUploadLinksTableHeading = Liens \xE9mis
settingsUploadLinksTableSubheading = Jetons d\u2019envoi invit\xE9s actifs
settingsUploadLinksTableLabel = Nom
settingsUploadLinksTablePreview = Aper\xE7u
settingsUploadLinksTableStatus = Statut
settingsUploadLinksTableCreated = Cr\xE9\xE9
settingsUploadLinksTableActions = Actions
settingsUploadLinksEmpty = Aucun lien d\u2019envoi n\u2019a encore \xE9t\xE9 cr\xE9\xE9.
settingsUploadLinksStatusActive = Actif
settingsUploadLinksStatusRevokedLabel = R\xE9voqu\xE9
settingsUploadLinksRevokedBadge = R\xE9voqu\xE9
...
settingsAccountKeyCopyLabel = Copier la cl\xE9 priv\xE9e
settingsAccountKeyStatusCopied = Cl\xE9 priv\xE9e copi\xE9e dans le presse-papiers.
settingsAccountKeyStatusError = Impossible de copier la cl\xE9. R\xE9essayez.
settingsAccountKeyStatusUnavailable = Cl\xE9 priv\xE9e indisponible.
