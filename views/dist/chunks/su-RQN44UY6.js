...
// locales/su.ftl
var su_default = `title = Go Send
importingFile = Ngimpor...
encryptingFile = Ng\xE9nkripsi...
decryptingFile = Ngad\xE9kripsi...
downloadCount =
    { $num ->
       *[other] { $num } undeuran
    }
...
notSupportedOutdatedDetail = Hanjakal Firefox v\xE9rsi ieu teu ngarojong t\xE9hnologi w\xE9b nu ngagerakkeun Send. Anjeun perlu ngapd\xE9t panyungsi anjeun.
updateFirefox = Apd\xE9t Firefox
...
passwordSetError = Ieu kecap sandi teu bisa dis\xE9t
...
introDescription = { -send-brand } migampang anjeun babagi koropak kalawan \xE9nkripsi tungtung-ka-tungtung sarta tutumbu nu otomatis kadaluwarsa. Sahingga anjeun bisa ngaraksa naon nu ku anjeun bagi sacara privat jeung mastikeun banda anjeun teu salawasna daring.
notifyUploadEncryptDone = Koropak anjeun ka\xE9nkripsi sarta siap dikirim.
...
downloadDescription = Ieu koropak geus dibagikeun liwat { -send-brand } kalawan \xE9nkripsi tungtung-ka-tungtung sarta tutumbuna otomatis kadaluwarsa.
...
notSupportedDescription = { -send-brand } moal jalan di ieu panyungsi. { -send-short-brand } jalan naker dina { -firefox } v\xE9rsi pamganyarna, sarta bakal jalan di loba panyungsi v\xE9rsi kiwari.
...
dragAndDropFiles = \xC9s\xE9rkeun sarta \xE9sotkeun koropak
# the second part of the string 'Drag and drop files or click to send up to 1GB'
# $size is the size of the file, displayed using the fileSize message as format (e.g. "2.5MB")
orClickWithSize = atawa klik pikeun ngirim nika { $size }
addPassword = Piningan ku kecap sandi
emailPlaceholder = Asupkeun sur\xE9l\xE9k anjeun
# $size is the size of the file, displayed using the fileSize message as format (e.g. "2.5MB")
...
accountBenefitDownloadCount = Bagikeun koropak ka balar\xE9a
accountBenefitTimeLimit =
    { $count ->
        [one] Aktipkeun tutumbu jang sapo\xE9eun
       *[other] Aktipkeun tutumbu jang { $count } po\xE9
    }
accountBenefitSync = Kokolakeun koropak nu dibagikeun ti parangkat mana w\xE9
accountBenefitMoz = Tengetan ngeunaan layanan { -mozilla } lianna
signOut = Kaluar
okButton = OK\xC9H
downloadingTitle = Ngundeur
noStreamsWarning = Ieu panyungsi kawasna mah teu bisa ngad\xE9krip koropak badag kieu.
noStreamsOptionCopy = Tiron tutumbu jang bukaeun di panyungsi s\xE9j\xE9n
noStreamsOptionFirefox = Pecakan panyungsi karesep kami
noStreamsOptionDownload = Tuluykeun ku ieu panyungsi
downloadFirefoxPromo = { -send-short-brand } t\xE9h disanggakeun keur anjeun kalawan { -firefox } sarwa anyar.
# the next line after the colon contains a file name
...
`;
export {
  su_default as default
};
//# sourceMappingURL=su-RQN44UY6.js.map
