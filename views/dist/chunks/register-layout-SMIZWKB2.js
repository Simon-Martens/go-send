...
var RegisterLayoutElement = class extends HTMLElement {
  ...
  async showSuccess(name) {
    ...
    container.innerHTML = "";
    const content = template.content.cloneNode(true);
    const { translate: translate2, translateElement: translateElement2 } = await import("./utils-ZQ6QW3AE.js");
  ...
  async setPlaceholders() {
    try {
      const { translate: translate2 } = await import("./utils-ZQ6QW3AE.js");
...
//# sourceMappingURL=register-layout-SMIZWKB2.js.map
