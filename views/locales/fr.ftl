...
downloadSecurityNotice = Tous les téléchargements, les données utilisateur associées et les interactions utilisateur sur cette page sont enregistrés. Les journaux sont régulièrement supprimés.
