...
errorPageHeader = Si \xE8 verificato un errore.
fileTooBig = Le dimensioni di questo file sono eccessive. Dovrebbe essere inferiore a { $size }.
linkExpiredAlt = Link scaduto
notSupportedHeader = Il browser in uso non \xE8 supportato.
notSupportedLink = Perch\xE9 questo browser non risulta supportato?
notSupportedOutdatedDetail = Purtroppo questa versione di Firefox non supporta le tecnologie web alla base di Send. \xC8 necessario aggiornare il browser.
...
whyJavascript = Perch\xE9 Send richiede JavaScript?
...
notifyUploadEncryptDone = Il file \xE8 crittato e pronto per l\u2019invio
...
downloadDescription = Questo file \xE8 stato condiviso tramite { -send-brand } con crittografia end-to-end e un link che scade automaticamente.
trySendDescription = Prova { -send-brand } per condividere file in modo semplice e sicuro.
# count will always be > 10
tooManyFiles = \xC8 possibile caricare solo { $count } file alla volta.
# count will always be > 10
tooManyArchives =
    { $count ->
        [one] \xC8 consentito solo un archivio.
       *[other] Sono consentiti solo { $count } archivi.
    }
expiredTitle = Questo link \xE8 scaduto.
notSupportedDescription = Non \xE8 possibile utilizzare { -send-brand } con questo browser. { -send-short-brand } funziona al meglio con l\u2019ultima versione di { -firefox } ma \xE8 compatibile con l\u2019ultima versione della maggior parte dei browser.
...
accountBenefitDownloadCount = Condividi file con pi\xF9 persone
...
noStreamsWarning = Questo browser potrebbe non essere in grado di decrittare un file cos\xEC grande.
...
downloadFirefoxPromo = { -send-short-brand } \xE8 offerto dal nuovissimo { -firefox }.
# the next line after the colon contains a file name
...
trailheadPromo = C\u2019\xE8 un modo per proteggere la tua privacy. Entra in Firefox.
learnMore = Ulteriori informazioni.
`;
export {
  it_default as default
};
//# sourceMappingURL=it-JURHVETE.js.map
